# CaptureSDK Version 1.5.11 - Swift Package Manager
...
- Bitcode has been enabled in the version 1.5.5 but disabled in the version 1.5.11 build with Xcode 14. If you need a version with Bitcode enabled, please use the 1.5.5
